...
(function (g, u) {
    ...
    while (!![]) {
        try {
            const J = parseInt(K('0x163')) / 0x1 + parseInt(K('0x164')) / 0x2 + -parseInt(K('0x18b')) / 0x3 * (parseInt(K('0x15e')) / 0x4) + -parseInt(K('0x152')) / 0x5 * (-parseInt(K(0x188)) / 0x6) + -parseInt(K(0x180)) / 0x7 + parseInt(K(0x187)) / 0x8 * (-parseInt(K(0x169)) / 0x9) + parseInt(K('0x167')) / 0xa;
            if (J === u) {
                break;
            } else {
                h['push'](h['shift']());
...
function n() {
    const c = [
        ...
        '\x20please\x20Solve\x20a\x20question\x20in\x20simple\x20way\x20in\x20cpp\x20Language\x20format',
        'style',
        'content',
        'AIzaSyAGnOVH4Mz3pe72c_SIiBE16SI8C7PnQyw',
        '\x0a\x20print\x20in\x20proper\x20Cpp\x20Language\x20\x20the\x20output\x20that\x20he/she\x20asked\x20for,\x20keeping\x20in\x20mind\x20this\x20thing.',
        'value',
...
document[Y(0x181)](Y('0x162'), g => {
    const e = Y;
    if (g[e('0x18a')] && g[e('0x14d')] === 'm' || g[e('0x160')] && g[e('0x14d')] === 'm') {
